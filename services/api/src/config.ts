...
export const config = {
  ...
  // CORS
  allowedOrigins: optional('ALLOWED_ORIGINS', 'https://alerteneige.app,https://www.alerteneige.app,http://localhost:3001,http://localhost:8081,http://localhost:19006').split(','),
